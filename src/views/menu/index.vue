    ...
    <template #wrapper>
      <el-card class="box-card">
        ...
        <el-table v-loading="loading" :data="menuList" row-key="id" :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
          <el-table-column label="菜单标题" prop="title" align="center" :show-overflow-tooltip="true" />
          ...
          <el-table-column label="创建时间" prop="created_on" align="center" :formatter="formatCreatedDate" />
          <el-table-column label="更新时间" prop="modified_on" align="center" :formatter="formatModifiedDate" />
